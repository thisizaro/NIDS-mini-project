...
Kaggle version — paths point to /kaggle/input/ and /kaggle/working/.

IMPORTANT: The dataset slug below must match your Kaggle dataset name.
Change DATASET_SLUG if your dataset is named differently.
"""
...
# Paths  (Kaggle layout)
# ─────────────────────────────────────────────
# *** CHANGE THIS if your Kaggle dataset slug is different ***
DATASET_SLUG = "datasets/chethuhn/network-intrusion-dataset"

DATASET_DIR = f"/kaggle/input/{DATASET_SLUG}"
PREPROCESSING_DIR = "/kaggle/working/preprocessing"
